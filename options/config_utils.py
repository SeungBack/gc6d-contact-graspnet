...
def load_config(checkpoint_dir, batch_size=None, max_epoch=None, data_path=None, arg_configs=None, save=False):
    """
    ...
    config_path = os.path.join('configs', checkpoint_dir)
    ...
    if save:
        with open(os.path.join(checkpoint_dir, checkpoint_dir),'w') as f:
